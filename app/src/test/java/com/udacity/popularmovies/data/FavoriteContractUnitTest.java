...
public class FavoriteContractUnitTest {
    @Test
    public void inner_class_exists() throws Exception {
        Class[] innerClasses = FavoriteContract.class.getDeclaredClasses();
    ...
    public void inner_class_members_correct() throws Exception {
        ...
        assertEquals("There should be exactly 10 members in the inner class", 10, allFields.length);
